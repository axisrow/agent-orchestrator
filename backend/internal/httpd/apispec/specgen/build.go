...
var schemaNames = map[string]string{
	...
	"ControllersSetSessionConfigRequest":                  "SetSessionConfigRequest",
	"ControllersSetSessionConfigResponse":                 "SetSessionConfigResponse",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPut, path: "/api/v1/sessions/{sessionId}/config", id: "setSessionConfig", tag: "sessions",
			summary:    "Set persistent per-session environment overrides",
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.SetSessionConfigRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.SetSessionConfigResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
